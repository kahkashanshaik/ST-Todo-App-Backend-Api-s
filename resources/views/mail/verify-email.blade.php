                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">Tap the button below to confirm your email address. If you didn't
                                create an account with <a href="#">Rozi Roti</a>, you can safely delete this
                                email.</p>
                        </td>
                    </tr>
                    <!-- end copy -->
                                            ...
                                            <tr>
                                                <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                                                    <a href="{{ $link }}" target="_blank"
                                                        style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Click
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">Cheers,<br> Rozi Roti</p>
                        </td>
                    </tr>
                    <!-- end copy -->
